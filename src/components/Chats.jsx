...
const Chats = () => {
  return (
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm fw-bold'>Baba thiame</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo  max-sm:hidden ">
     <span className='text-sm fw-bold'>Yacine Diop</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm fw-bold'>mouhamed loum</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm fw-bold'>Rama fall</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm fw-bold'>saliou thioune</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm fw-bold'>Mamadou niang</span>
     <p className='text-sm text-gray-300 pl-0'>Hellow</p>
     </div>
      </div>
    </div>
  )
