...
const Chats = () => {
  return (
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm'>Baba thiame</span>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm'>Yacine Diop</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm'>mouhamed loum</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm'>Rama fall</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm'>saliou thioune</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    ...
    <div className="userChatinfo max-sm:hidden">
     <span className='text-sm'>Mamadou niang</span>
     <p className='text-sm text-gray-300'>Hellow</p>
     </div>
      </div>
    </div>
