...
<input type="text" placeholder="Search "  className="bg-transparent border-none  text-black w-100   outline-none max-sm:w-full shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 "/>
      </div>
...
<span class='fw-bold text-black'>makhan</span>
</div>
      </div>
      </div>
  )
