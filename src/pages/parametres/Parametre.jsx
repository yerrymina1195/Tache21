              ...
              <div class="row gx-3">
                <div className="col-md-6 bg-danger  p-4">
                  <div className="col-md-6  p-4">
                    ...
                    />
                    {imageURL && (
                      <img id="image" src={imageURL} alt="Selected" />
                    )}
                  </div>
                </div>
                <div className="col-md-6 bg-dark d-flex justify-content-md-end align-items-lg-end justify-content-sm-start align-items-sm-start">
                  <img
                    class="img-account-profile rounded-circle"
                    src="https://img.freepik.com/vecteurs-premium/profil-personnage-dessin-anime-avatar-homme-affaires_18591-50581.jpg?w=2000"
                    alt="Profil"
                  />
                </div>
              </div>
                  ...
                  <div class="row gx-3 mb-3">
                    ...
                    <div class="col-md-6">
                      <LabelInput
                        ...
                        placeholder="Colobane Parc Amazout"
                        type="text"
                      />
                    </div>
                  </div>
